...
MOCK_MODULES = ['numpy', 'scipy', 'scipy.ndimage', 'scipy.stats', 'matplotlib', 'matplotlib.pyplot', 'numpy.ma', 'matplotlib.ticker',
                'matplotlib.patches', 'matplotlib.gridspec', 'matplotlib.image', 'matplotlib.dates', 'matplotlib.cbook',
                'mpl_toolkits.basemap.proj', 'math', 'mpl_toolkits.basemap.Basemap', 'mpl_toolkits.basemap', 'mapnik',
                'pandas', 'netCDF4', 'pyspatialite', 'pyspatialite.dbapi2', 'cartopy', 'cartopy.crs', 'cartopy.feature', 'pyproj',
                'osgeo.ogr', 'gdal', 'simplekml', '_geoslib', 'mpl_toolkits.basemap.pyproj', 'yaml']
...
version = faam_wxrx.__version__
# The full version, including alpha/beta/rc tags.
release = faam_wxrx.__version__ + " (" + faam_wxrx.__status__ + ")"
